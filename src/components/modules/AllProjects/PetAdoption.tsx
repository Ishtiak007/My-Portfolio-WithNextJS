        ...
        <div className="p-4">
          ...
          <div className="my-4">
            <div className="flex flex-col sm:flex-row sm:justify-between gap-2 sm:gap-0">
              ...
              {/* Live Link */}
              <a
                href="https://pet-adoption-assignment.web.app/"
                target="_blank"
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between gap-2 sm:gap-0 my-3">
              {/* Frontend github */}
              <a
                href="https://github.com/Ishtiak007/Pet-Adoption-Client-Side/tree/main"
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-[140px] px-4 py-2 rounded-xl bg-gray-800 text-sm font-bold flex items-center justify-center gap-2 text-white shadow-md transition-all duration-300 ease-in-out hover:bg-gray-700 hover:scale-105 hover:shadow-lg active:scale-95"
              >
              ...
              <a
                href="https://github.com/Ishtiak007/Pet-Adoption-Server-Side"
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-[140px] px-4 py-2 rounded-xl bg-gray-800 text-sm font-bold flex items-center justify-center gap-2 text-white shadow-md transition-all duration-300 ease-in-out hover:bg-gray-700 hover:scale-105 hover:shadow-lg active:scale-95"
              >
            ...
            <div className="max-w-screen-xl mx-auto space-y-7">
              <div>
                ...
                <p className="text-center">
                  This platform is all about making a real difference in pet
                  welfare. Users can easily add and manage pets, while uploaders
                  help connect loving animals with caring homes. It’s designed
                  to build meaningful connections and make adoption simple and
                  heartfelt. Want to help injured pets? Launch or support
                  donation campaigns with secure payments powered by Stripe.
                  Admins keep everything running smoothly—managing users, pets,
                  and campaigns while ensuring transparency through detailed
                  payment histories.
                </p>
              </div>
