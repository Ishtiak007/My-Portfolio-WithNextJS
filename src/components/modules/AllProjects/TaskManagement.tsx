...
import ProjectCardImage from "../../../../public/assets/TaskManagement/TM1.png";
...
const TaskManagement = () => {
  ...
  const data = [
    {
      img: "/assets/TaskManagement/TM2.png",
    },
    {
      img: "/assets/TaskManagement/TM3.png",
    },
    {
      img: "/assets/TaskManagement/TM4.png",
    },
  ];
      ...
      <div className="overflow-hidden rounded-xl shadow-lg bg-white/5 border-white/10 backdrop-blur-lg">
        ...
        <div className="p-4">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-[13px] sm:text-base mb-4">
            Elevate productivity with my Task Management App—simplifying task
            organization, boosting focus, and ensuring seamless workflow
            efficiency.
          </p>
          ...
          <div className="my-4">
            <div className="flex flex-col sm:flex-row sm:justify-between gap-2 sm:gap-0">
              ...
              {/* Live Link */}
              <a
                href="https://task-management-project-12ff9.web.app/"
                target="_blank"
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between gap-2 sm:gap-0 my-3">
              {/* Frontend github */}
              <a
                href="https://github.com/Ishtiak007/Task-Management-Client"
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-[140px] px-4 py-2 rounded-xl bg-gray-800 text-sm font-bold flex items-center justify-center gap-2 text-white shadow-md transition-all duration-300 ease-in-out hover:bg-gray-700 hover:scale-105 hover:shadow-lg active:scale-95"
              >
              ...
              <a
                href="https://github.com/Ishtiak007/Task-Management-Server"
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-[140px] px-4 py-2 rounded-xl bg-gray-800 text-sm font-bold flex items-center justify-center gap-2 text-white shadow-md transition-all duration-300 ease-in-out hover:bg-gray-700 hover:scale-105 hover:shadow-lg active:scale-95"
              >
            ...
            <div className="max-w-screen-xl mx-auto space-y-7">
              <div>
                ...
                <p className="text-center">
                  Designed to simplify organization and streamline your
                  workflow, this task management system helps you stay focused,
                  organized, and efficient—every step of the way.
                </p>
              </div>
