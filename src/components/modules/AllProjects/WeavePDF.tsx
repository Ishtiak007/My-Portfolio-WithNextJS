            ...
            <div className="max-w-screen-xl mx-auto space-y-7">
              <div>
                ...
                <p className="text-center">
                  WeavePDF empowers your productivity by streamlining document
                  handling. With essential features and enhanced tools, it makes
                  managing PDFs quick, easy, and efficient, helping you stay
