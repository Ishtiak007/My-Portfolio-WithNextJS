...
import ProjectCardImage from "../../../../public/assets/LibraryManagement/longImg.jpg";
...
const LibraryManagement = () => {
  ...
  const data = [
    {
      img: "/assets/LibraryManagement/img1.png",
    },
    {
      img: "/assets/LibraryManagement/img2.png",
    },
    {
      img: "/assets/LibraryManagement/img3.png",
    },
    {
      img: "/assets/LibraryManagement/img4.png",
    },
    {
      img: "/assets/LibraryManagement/img5.png",
    },
    {
      img: "/assets/LibraryManagement/img6.png",
    },
    {
      img: "/assets/LibraryManagement/img7.png",
    },
    {
      img: "/assets/LibraryManagement/img8.png",
    },
  ];
  return (
      ...
      <div className="overflow-hidden rounded-xl shadow-lg bg-[#173447]">
        ...
        <div className="p-4">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-[13px] sm:text-base mb-4">
            A comprehensive Library Management System enabling efficient
            organization, tracking, and access to literary resources for both
          ...
          <div className="my-4">
            <div className="flex flex-col sm:flex-row sm:justify-between gap-2 sm:gap-0">
              ...
              {/* Live Link */}
              <a
                href="https://incomparable-chimera-840827.netlify.app/"
                target="_blank"
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between gap-2 sm:gap-0 my-3">
              {/* Frontend github */}
              <a
                href="https://github.com/Ishtiak007/Library-Management-Fontend"
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-[140px] px-4 py-2 rounded-xl bg-gray-800 text-sm font-bold flex items-center justify-center gap-2 text-white shadow-md transition-all duration-300 ease-in-out hover:bg-gray-700 hover:scale-105 hover:shadow-lg active:scale-95"
              >
              ...
              <a
                href="https://github.com/Ishtiak007/Library-Management-Backend"
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-[140px] px-4 py-2 rounded-xl bg-gray-800 text-sm font-bold flex items-center justify-center gap-2 text-white shadow-md transition-all duration-300 ease-in-out hover:bg-gray-700 hover:scale-105 hover:shadow-lg active:scale-95"
              >
            ...
            <div className="max-w-screen-xl mx-auto space-y-7">
              <div>
                ...
                <p className="text-center">
                  This all-in-one platform makes it easy to organize, track, and
                  access books and other resources. Users can browse, borrow,
                  and manage their reading lists, while admins handle inventory,
                  user activity, and overall system maintenance with ease. It’s
                  a seamless solution for keeping libraries well-managed and
                  readers happy.
                </p>
              </div>
